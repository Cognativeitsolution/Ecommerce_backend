                        ...
                        <div class="featured_cpn_wrapper">
                           ...
                           <div class="featured_details">
                              ...
                              <div class="code_btn_container">
                                 <a href="javascript:void(0);" data-toggle="modal" onclick="getCodeDeal({{ $featured_offer->id }})" data-target="#{{ $featured_offer->id }}" class="coupon_btn_a <?php echo ($featured_offer->code == 1) ? '' : 'deal'; ?> show_coupon homepage" data-id="24303" data-clipboard-text="WELCOME10" "="" data-text="**LCOME10">
         ...
         <div class="row">
            <div class="col-md-12">
               ...
               @foreach($popular_categories as $popular_category)
                  <a href="{{ url('stores/' .$popular_category->slug) }}" class="cat_item cat_item-one">
                     ...
                     @foreach($latest_offers as $latest_offer)
                        <div class="featured_cpn_wrapper">
                           ...
                           <div class="featured_details">
                              ...
                              <div class="code_btn_container">
                                 <a href="javascript:void(0);" data-toggle="modal" onclick="getCodeDeal({{ $latest_offer->id }})" data-target="#{{ $latest_offer->id }}" class="coupon_btn_a <?php echo ($latest_offer->code == 1) ? '' : 'deal'; ?> show_coupon homepage" data-id="24303" data-clipboard-text="WELCOME10" "="" data-text="**LCOME10">
