        ...
        <form name="add-page" id="add-page" method="post" enctype="multipart/form-data" action="{{ route('pages.store')}}">
          ...
          <div class="form-check-inline">
            <label class="form-check-label" for="coupon">
              <input type="radio" value=1 class="form-check-input" checked="checked" name="type" id="coupon">Coupon Site
            </label>
          </div>
          <div class="form-check-inline">
            <label class="form-check-label" for="blog">
              <input type="radio" value=0 class="form-check-input" name="type" id="blog">Blog Site
            </label>
          </div>
          <hr>
