          ...
          <div class="row">
            ...
            <div class="form-check-inline">
              <label class="form-check-label" for="coupon">
                <input type="radio" value=1 class="form-check-input" name="type" id="coupon" {{ $record->type == 1 ? 'checked' : '' }}>Coupon Site
              </label>
            </div>
            <div class="form-check-inline">
              <label class="form-check-label" for="blog">
                <input type="radio" value=0 class="form-check-input" name="type" id="blog" {{ $record->type == 0 ? 'checked' : '' }}>Blog Site
              </label>
            </div>
            <hr>
