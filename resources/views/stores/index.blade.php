      ...
      @endif
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
           ...
           @can('store-create')
            <div class="col-sm-4">
              <a href="{{ route('stores.create') }}" class="btn btn-block btn-primary main-btn">Add</a>
            </div>
           @endcan
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">All Stores</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <div class="row">
                    <div class="col-sm-6">
                    <span class="tbl-head">Displaying {{$record->count()}} of {{ $record->total() }} store(s).</span> 

                    </div>
                    <div class="col-sm-6">
                    <form class="float-right" name="user_search" id="" method="get" action="{{ route('stores.index')}}">
                ...
                <div class="card-body table-responsive p-0">
                  <table class="table table-hover text-nowrap">
                    ...
                    @if ($record->count() == 0)
                    <tr>
                        <td colspan="6">No stores to display.</td>
                    </tr>
                    @endif
                      ...
                      @foreach( $record as $store)
                        <tr>
                          ...
                          <td width="150" style="text-align:center;">
                            @can('store-edit')
                            <a href="{{ route('stores.edit', $store->id)}}" class="btn btn-primary tableaction">Edit</a>
                            @endcan
                            
                            @can('store-delete')
                              
                              <form class="tableaction" action="{{ route('stores.destroy', $store->id)}}" method="post">
                                @csrf
                                @method('DELETE')
