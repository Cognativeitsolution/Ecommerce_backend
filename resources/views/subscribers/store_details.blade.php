                        ...
                        @foreach($store->coupon as $coupon)
                            <div class="coupon coupon_card <?php echo ($coupon->code == 1) ? 'coupan_content' : 'deal_content'; ?> ">
                                ...
                                <div class="ss_coupon-code">
                                    <a href="javascript:void(0);"  data-toggle="modal" onclick="getCodeDeal({{ $coupon->id }}),copy_code({{ $coupon->id }})" data-target="#{{ $coupon->id }}" class="show_coupon coupon_btn_a deal show_coupon homepage" data-text="No Code!">
